...
local Window = Library.CreateLib("Menu", "RJTheme5")
...
Section:NewTextBox("HipHeight", "You are like a bird", function(txt)
...
Section:NewButton("VFly", "You can fly in a car", function()

    loadstring(game:HttpGet("https://pastebin.com/raw/MHE1cbWF"))()

end)

Section:NewButton("Arceus x V3 Fly", "Fly as in the original Arceus x", function()
...
Section:NewButton("Infinite Yield", "IY Gui", function()

    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()

end)

Section:NewButton("Dark Dex", "Dark Dex Gui", function()

    loadstring(game:HttpGet("https://scriptblox.com/raw/Universal-Script-Dark-Dex-V3-Secured-(Bypass-Dex-Detections)-4163", true))()

end)

Section:NewButton("Simple V3", "Simple Gui", function()
...
Section:NewButton("Super Power", "You are throwing things very far", function()
...
Section:NewButton("Auto Farm", "Auto Farm Gui", function()

    local library = loadstring(game:HttpGet("https://pastebin.com/raw/5KtmRcCe",true))()

end)

Section:NewButton("Kill Aura", "Kill Aura Gui", function()
